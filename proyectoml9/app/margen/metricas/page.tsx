  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <KpiCard label="Neto ‘te quedó’" value={totals.net} hint="Suma neta por operación (Cobros)." tone="neutral" />
        <KpiCard label="COGS" value={totals.cogs} hint="Costo mercadería vendida (según modo de costo)." tone="neutral" />
        <KpiCard label="Margen neto real" value={totals.marginNet} hint={`Margen % sobre bruto: ${pct(totals.marginPct)}`} tone={totals.marginNet >= 0 ? "good" : "bad"} />
      </div>
