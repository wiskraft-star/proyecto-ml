...
import { BarChart3, Crown, LayoutDashboard, Package, PlugZap, RotateCcw, Settings, ShieldCheck, Tag, TrendingUp, Wallet, Percent } from "lucide-react";
...
export const NAV: NavItem[] = [
  ...
  { href: "/catalogo", label: "Catálogo", icon: Crown, section: "Operación" },
  ...
  // MVP: sistema operativo para margen neto real (Ventas + Cobros + COGS + Insumos + Mano de obra)
  { href: "/margen", label: "Margen (MVP)", icon: Percent, section: "Finanzas" },
  // Métricas enfocadas en facturación (UI-only por ahora)
  { href: "/reportes", label: "Métricas", icon: BarChart3, section: "Finanzas" },
