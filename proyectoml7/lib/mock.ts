...
export type BuyBoxStatus = "Ganando" | "Compitiendo" | "Perdiendo" | "No elegible";

export type CatalogBuyBoxRow = {
  ...
  priceCash: number;
  priceCuotas: number;
  priceToWinCash: number;
  priceToWinCuotas: number;
  statusCash: BuyBoxStatus;
  statusCuotas: BuyBoxStatus;
  gapCash: number; // our - toWin
  gapCuotas: number;
...
export type CatalogCompetitorOffer = {
  ...
  price: number;
  cuotas: boolean;
  shipping: "Full" | "Flex" | "ME";
  etaDays: number;
  rep: "Platinum" | "Gold" | "Green" | "Yellow";
  winner: boolean;
};

export function catalogBuyBoxMock() {
  const rows: CatalogBuyBoxRow[] = [
    {
      catalogProductId: "MLA-CAT-45462708",
      title: "Xiaomi Redmi 14C 256GB (Violeta) – Catálogo",
      sku: "REDMI14C-256",
      ourItemId: "MLA1578118259",
      priceCash: 334_971,
      priceCuotas: 359_999,
      priceToWinCash: 310_199,
      priceToWinCuotas: 339_999,
      statusCash: "Perdiendo",
      statusCuotas: "Compitiendo",
      gapCash: 24_772,
      gapCuotas: 20_000,
      updatedAt: "2025-12-13",
    },
    {
      catalogProductId: "MLA-CAT-45462707",
      title: "Xiaomi Redmi 14C 128GB (Negro) – Catálogo",
      sku: "REDMI14C-128",
      ourItemId: "MLA1578014623",
      priceCash: 288_471,
      priceCuotas: 308_971,
      priceToWinCash: 288_471,
      priceToWinCuotas: 308_971,
      statusCash: "Ganando",
      statusCuotas: "Ganando",
      gapCash: 0,
      gapCuotas: 0,
      updatedAt: "2025-12-13",
    },
    {
      catalogProductId: "MLA-CAT-ACC-USB-C",
      title: "Cable USB-C Reforzado 1m – Catálogo",
      sku: "ACC-CABLE",
      ourItemId: "MLA2010210390",
      priceCash: 7_499,
      priceCuotas: 8_499,
      priceToWinCash: 6_999,
      priceToWinCuotas: 7_999,
      statusCash: "Compitiendo",
      statusCuotas: "Perdiendo",
      gapCash: 500,
      gapCuotas: 500,
      updatedAt: "2025-12-13",
    },
    {
      catalogProductId: "MLA-CAT-ACC-AURIC",
      title: "Auriculares In-Ear – Catálogo",
      sku: "ACC-AURIC",
      ourItemId: "MLA1581329863",
      priceCash: 13_990,
      priceCuotas: 15_990,
      priceToWinCash: 13_990,
      priceToWinCuotas: 15_490,
      statusCash: "Ganando",
      statusCuotas: "Compitiendo",
      gapCash: 0,
      gapCuotas: 500,
  ...
  // To keep TS simple without boolean capitalization issues in generated content,
  // we will build offers procedurally below:
  const offers2: CatalogCompetitorOffer[] = [
    { catalogProductId: "MLA-CAT-45462708", seller: "Competidor A", price: 310_199, cuotas: false, shipping: "ME", etaDays: 3, rep: "Gold", winner: true },
    { catalogProductId: "MLA-CAT-45462708", seller: "Competidor B", price: 310_199, cuotas: true, shipping: "ME", etaDays: 3, rep: "Gold", winner: false },
    { catalogProductId: "MLA-CAT-45462708", seller: "Tu oferta", price: 334_971, cuotas: false, shipping: "ME", etaDays: 2, rep: "Platinum", winner: false },
    { catalogProductId: "MLA-CAT-45462708", seller: "Tu oferta", price: 359_999, cuotas: true, shipping: "ME", etaDays: 2, rep: "Platinum", winner: false },

    { catalogProductId: "MLA-CAT-45462707", seller: "Tu oferta", price: 288_471, cuotas: false, shipping: "ME", etaDays: 2, rep: "Platinum", winner: true },
    { catalogProductId: "MLA-CAT-45462707", seller: "Tu oferta", price: 308_971, cuotas: true, shipping: "ME", etaDays: 2, rep: "Platinum", winner: true },
    { catalogProductId: "MLA-CAT-45462707", seller: "Competidor C", price: 291_990, cuotas: true, shipping: "ME", etaDays: 3, rep: "Gold", winner: false },

    { catalogProductId: "MLA-CAT-ACC-USB-C", seller: "Competidor D", price: 6_999, cuotas: false, shipping: "Flex", etaDays: 1, rep: "Green", winner: true },
    { catalogProductId: "MLA-CAT-ACC-USB-C", seller: "Competidor D", price: 7_999, cuotas: true, shipping: "Flex", etaDays: 1, rep: "Green", winner: false },
    { catalogProductId: "MLA-CAT-ACC-USB-C", seller: "Tu oferta", price: 7_499, cuotas: false, shipping: "ME", etaDays: 2, rep: "Platinum", winner: false },
    { catalogProductId: "MLA-CAT-ACC-USB-C", seller: "Tu oferta", price: 8_499, cuotas: true, shipping: "ME", etaDays: 2, rep: "Platinum", winner: false },

    { catalogProductId: "MLA-CAT-ACC-AURIC", seller: "Competidor E", price: 13_990, cuotas: false, shipping: "ME", etaDays: 3, rep: "Gold", winner: false },
    { catalogProductId: "MLA-CAT-ACC-AURIC", seller: "Competidor E", price: 15_490, cuotas: true, shipping: "ME", etaDays: 3, rep: "Gold", winner: true },
    { catalogProductId: "MLA-CAT-ACC-AURIC", seller: "Tu oferta", price: 13_990, cuotas: false, shipping: "ME", etaDays: 2, rep: "Platinum", winner: true },
    { catalogProductId: "MLA-CAT-ACC-AURIC", seller: "Tu oferta", price: 15_990, cuotas: true, shipping: "ME", etaDays: 2, rep: "Platinum", winner: false },
  ];

  return { rows, offers: offers2 };
}
