...
Nota: el proyecto ejecuta `prisma generate` automáticamente antes de `next build` (script `npm run build`).

En plataformas como Vercel, esto evita fallas por variables de entorno no disponibles durante `npm install`.
